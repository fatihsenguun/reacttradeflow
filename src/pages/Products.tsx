  ...
  return (
    <div>
      ...
      <div className='flex justify-between items-center mb-6'>
        ...
        <button className='bg-white/5 backdrop-blur-md border border-white/10 cursor-pointer hover:bg-white/10 w-30 h-10 text-sm rounded-lg text-slate-200 transition-colors' onClick={() => navigate("/products/add")}>+ Add Product </button>
      </div>
