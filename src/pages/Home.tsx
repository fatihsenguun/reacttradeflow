      ...
      <div className='lg:col-span-3 grid grid-cols-1 lg:grid-cols-3 gap-6'>
        ...
        <div className='grid grid-cols-3 bg-slate-800 h-26 rounded-lg shadow-sm flex items-center justify-center hover:bg-slate-700 cursor-pointer transition-colors  gap-4 p-3 '>
          ...
          <div className='col-span-2 flex flex-col overflow-hidden'>
            <span className='text-sm font-medium text-white truncate'>Total Sales</span>
            <span className='text-xs text-slate-400'>12.400</span>
          </div>



        </div>
        <div className='bg-slate-800 h-26 rounded-lg shadow-sm'></div>
        <div className='bg-slate-800 h-26 rounded-lg shadow-sm'></div>
